...
public class WXPayRequest {
    ...
    private static String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        if (useCert) {
            // 证书
            char[] password = WXUtilsConfig.MCH_ID.toCharArray();
        ...
        httpPost.addHeader("User-Agent", "wxpay sdk java v1.0 " + WXUtilsConfig.MCH_ID);
    ...
    public static String requestWithCert(String urlSuffix, String uuid, String data) throws Exception {
        return requestOnce(WXUtilsConfig.DO_MAIN,urlSuffix, uuid, data, WXUtilsConfig.HTTP_CONNECT_TIMEOUTMS, WXUtilsConfig.HTTP_READ_TIMEOUTMS,true);
    }
}