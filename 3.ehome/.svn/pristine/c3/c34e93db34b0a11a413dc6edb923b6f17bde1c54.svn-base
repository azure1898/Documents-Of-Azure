...
<body>
    <ul class="nav nav-tabs">
        <li>
            <span><a href="${ctx}/module/villageLine/recommendList">模块管理 </a>> <a href="${ctx}/module/villageLine/recommendList">推荐管理</a></span>
        </li>
    </ul>
    <form:form id="searchForm" modelAttribute="villageLine" action="${ctx}/module/villageLine/recommendList" method="post" class="breadcrumb form-search">
        ...
        <input type="text" class="hide" id="hidVillageId" value="${villageLine.villageInfo.id }">
        <ul class="ul-form">
            <li class="btns">
    ...
    <ul style="margin: 10px;">
        <li>
            <shiro:hasPermission name="module:villageLine:setRecom">
                <a id="elemEditId" href="${ctx}/module/villageLine/mainRecomFrom?id=" onclick="return elemSetMondule()" class="btn btn-primary">设置推荐</a>
            </shiro:hasPermission>
        </li>
    </ul>
