...
<body>
    <ul class="nav nav-tabs">
        <li>
            ...
            <a href="${ctx}/business/businessAccount?businessinfoId=<%=businessinfoId %>">管理账户</a>
            </span>
        </li>
    </ul>
    ...
    <ul style="margin: 10px;">
        <li style="list-style-type: none;">
            ...
            <shiro:hasPermission name="business:businessAccount:edit">
                <a id="btuElemEdit" href="${ctx}/business/businessAccount/form?businessinfoId=<%=businessinfoId %>&prodType=<%=prodType %>&id=" onclick="return elemEdit('商家账号')" class="btn btn-primary"><i class="icon-edit icon-custom"></i> 编辑</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="business:businessAccount:frozen">
                <a id="btuElemFozen" href="${ctx}/business/businessAccount/updateLoginFlag?businessinfoId=<%=businessinfoId %>&id=" class="btn btn-primary" onclick="return elemFrozen('loginFlag', '商家账号', 'frozen', true)">冻结</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="business:businessAccount:unfrozen">
                <a id="btuElemFozen" href="${ctx}/business/businessAccount/updateLoginFlag?businessinfoId=<%=businessinfoId %>&id=" class="btn btn-primary" onclick="return elemFrozen('loginFlag', '商家账号', 'unfrozen', true)">取消冻结</a>
            </shiro:hasPermission>
            <shiro:hasPermission name="business:businessAccount:delete">
                <a id="btuElemDelete" href="${ctx}/business/businessAccount/delete?businessinfoId=<%=businessinfoId %>&id=" onclick="return elemDelete('商家账号')" class="btn btn-primary"><i class="icon-trash icon-custom"></i> 删除</a>
            </shiro:hasPermission>
        </li>
    </ul>
