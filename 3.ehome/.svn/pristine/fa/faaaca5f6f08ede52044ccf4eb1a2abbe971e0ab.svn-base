...
<body>
    ...
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '1'}">
        <input id="btnElemDispatching" class="commonbtn" style="width:60px;" type="button" value="去配送" onclick="window.location.href='${ctx}/order/orderGoods/dispatching?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '0'}">
        <input id="btnElemAccept" class="commonbtn" type="button" style="width:60px;" value="受理" onclick="window.location.href='${ctx}/order/orderGoods/accept?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '2'}">
        <input id="btnElemComplete" class="commonbtn" type="button" style="width:60px;" value="完成" onclick="window.location.href='${ctx}/order/orderGoods/complete?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.orderState !=  '3' && orderGoods.orderState !=  '4'}">
        <input id="btnElemCancel" class="commonbtn" type="button" style="width:60px;" data-toggle="modal" data-target="#myModal" value="取消" />
    </c:if>
    <!-- 模态框（Modal） -->
    ...
    <table  class="table table-striped table-bordered table-condensed" style="width:98.3%">
        ...
        <c:forEach items="${orderGoods.orderGoodsList}" var="orderGoodsTemp">
            <tr>
                ...
                <td>
                    <img src="${orderGoodsTemp.imageUrl}" style="width:53px;height:40px;"/>
                </td>
        </c:forEach>
            <tr>
    ...
    <div style=" margin-left:15px;">
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '1'}">
        <input id="btnElemDispatchinDown" class="commonbtn" type="button" style="width:60px;" value="去配送" onclick="window.location.href='${ctx}/order/orderGoods/dispatching?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '0'}">
        <input id="btnElemAcceptDown" class="commonbtn" type="button" value="受理" style="width:60px;" onclick="window.location.href='${ctx}/order/orderGoods/accept?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.payState == '1' && orderGoods.orderState ==  '2'}">
        <input id="btnElemCompleteDown" class="commonbtn" type="button" value="完成" style="width:60px;" onclick="window.location.href='${ctx}/order/orderGoods/complete?id=${orderGoods.id}&updateDate=${orderGoods.updateDateString}'"/>
    </c:if>
    <c:if test="${orderGoods.orderState !=  '3' && orderGoods.orderState !=  '4'}">
