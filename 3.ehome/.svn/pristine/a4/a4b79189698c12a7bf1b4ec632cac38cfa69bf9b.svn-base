...
import com.its.modules.sys.security.SystemAuthorizingRealm;
...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public User getUserByLoginName2(String loginName) {
	    return UserUtils.getByLoginName2(loginName);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public void updateUserLoginFlag(User user) {
		// 修改用户登录状态
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://its111.com\r\n");
		sb.append("\r\n======================================================================\r\n");
