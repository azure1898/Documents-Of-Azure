    ...
    $(document).ready(function() {
        ...
        $("#inputForm").validate({
            ...
            submitHandler : function(form) {
                ...
                if (KindEditor.instances[0].html().length > 1900) {
                    $(".word_message").show();
                    return;
                }
                if(villageIdList==''){
...
<body>
    <ul class="nav nav-tabs">
        <li>
            <span><a href="${ctx}/setup/businessInfo/">商家设置 ></a>商家资料</span>
        </li>
    </ul>
    <br />
                        ...
                        <div class="z_photo upimg-div clear" style="width: 150px;">
                            <c:if test="${businessInfo.businessPic != ''}">
                                <section class="up-section fl">
                                    <span class="up-span"></span> <img src="${ctxStatic}/images/a7.png" class="close-upimg"> <img src="${businessInfo.businessPic}" class="up-img">
                                </section>
                            </c:if>
