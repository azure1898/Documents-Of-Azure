...
<body>
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/adver/adverManage/">广告信息列表</a></li>
        <li class="active"><a href="${ctx}/adver/adverManage/form?id=${adverManage.id}">广告信息<shiro:hasPermission name="adver:adverManage:edit">${not empty adverManage.id?'修改':'添加'}</shiro:hasPermission> <shiro:lacksPermission name="adver:adverManage:edit">查看</shiro:lacksPermission></a></li>
    </ul>
    <br />
    <form:form id="inputForm" modelAttribute="adverManage" action="${ctx}/adver/adverManage/save" enctype="multipart/form-data" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label">广告位置ID：</label>
            <div class="controls">
                            ...
                            <div class="z_photo upimg-div clear" style="width: 150px;">
                                <c:if test="${adverManage.adverPic != '' && adverManage.adverPic !=null}">
                                    <section class="up-section fl">
                                        <span class="up-span"></span> <img src="${ctxStatic}/images/a7.png" class="close-upimg"> <img src="${adverManage.adverPic}" class="up-img">
                                    </section>
                                </c:if>
                                <section class="z_file fl" <c:if test="${adverManage.adverPic != '' && adverManage.adverPic !=null}">style="display: none;"</c:if>>
                                    <img src="${ctxStatic}/images/a10.png" class="add-img"> <input type="file" name="file" id="file" class="file" value="" accept="image/jpg,image/jpeg,image/png,image/bmp" />
                                </section>
                            </div>
                        </section>
                    </div>
