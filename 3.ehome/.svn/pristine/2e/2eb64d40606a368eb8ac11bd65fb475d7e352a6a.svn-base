...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/balance/businessBalanceDetail/">商家结算明细信息列表</a></li>
		<li class="active"><a href="${ctx}/balance/businessBalanceDetail/form?id=${businessBalanceDetail.id}">商家结算明细信息<shiro:hasPermission name="balance:businessBalanceDetail:edit">${not empty businessBalanceDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="balance:businessBalanceDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="businessBalanceDetail" action="${ctx}/balance/businessBalanceDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="tradeCompleteTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${businessBalanceDetail.tradeCompleteTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="balance:businessBalanceDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
