...
<body>
    ...
    <input id="btnBack" style="width:60px;" class="commonbtn" type="button" value="返回" onclick="history.go(-1)"/>
    </div>
    </div>
    ...
    <input id="btnBackDown" style="width:60px;" class="commonbtn" type="button" value="返回" onclick="history.go(-1)"/>
    </div>
    </div>
</body>
</html>