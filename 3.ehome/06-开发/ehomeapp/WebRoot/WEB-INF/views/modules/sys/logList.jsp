...
<body>
	<ul class="nav nav-tabs" id="logType">
		<li><a href="${ctx}/sys/log?type=1">操作日志</a></li> 
		<li><a href="${ctx}/sys/log?type=2">登录日志</a></li> 
		<li><a href="${ctx}/sys/log?type=3">错误日志</a></li> 
		<li><a href="${ctx}/sys/log?type=4">安全日志</a></li> 
	</ul> 
	<script type="text/javascript">
	 	var type=<%=type%>;
	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post"
		...
		<div style="margin-top: 8px;">
			<label>日期范围：&nbsp;</label>
			<input id="beginDate" name="beginDate" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate" value="<fmt:formatDate value="${log.beginDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			<label>&nbsp;--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input
			...
			<input id="createBy.loginName" placeholder="用户名" name="createBy.loginName" type="text" maxlength="50" class="input-small" value="${log.createBy.loginName}" /> 
			&nbsp;&nbsp;&nbsp;
