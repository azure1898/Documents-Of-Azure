...
<head>
	...
	<style type="text/css">
		...
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 宋体;font-size:26px;padding-left:33px;}
		#footer {margin:8px 0 0 0;padding:3px 0 0 0;font-size:11px;text-align:center;border-top:2px solid #0663A2;}
		#footer, #footer a {color:#999;} #left{overflow-x:hidden;overflow-y:auto;background: #eaedf1;} #left .collapse{position:static;}
		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right" >
					<li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fnc:getCurrentSiteId()}.html" target="_blank" title="访问网站主页"><div class="nav_right">首页</div></a></li>
					...
					<li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame"><div class="nav_left">修改密码</div></a></li>
					<li>&nbsp;</li>
				</ul>
				<!-- 分割线 -->
