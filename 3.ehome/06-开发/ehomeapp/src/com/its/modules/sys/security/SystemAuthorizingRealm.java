 ...
 */
package com.its.modules.sys.security;
...
import com.its.common.web.Servlets;
...
import com.its.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			// 记录登录日志
			LogUtils.saveLog(Servlets.getRequest(), "系统登录",Log.TYPE_LOGIN);
			return info;
		} else {
			return null;
		}
