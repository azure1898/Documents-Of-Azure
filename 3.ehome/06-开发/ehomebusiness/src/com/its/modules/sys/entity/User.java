...
import com.its.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private String businessinfoId;// 商家编号
	...
	private String soundWarn;//是否声音提示
	private String stockWarn;//是否库存预警
	private String stockWarnNum;//库存预警值
	private List<Role> roleList = Lists.newArrayList(); // 拥有角色列表

	private String villageInfoIds;// 用户权限内的楼盘ID列表
	...
	public String getVillageInfoIds() {
		return villageInfoIds;
	}
