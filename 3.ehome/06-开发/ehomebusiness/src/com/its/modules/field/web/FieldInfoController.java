...
public class FieldInfoController extends BaseController {
	...
	public String form(FieldInfo fieldInfo, Model model) {
	...
	public String save(FieldInfo fieldInfo, String[] weekStr, FieldInfoPriceList fieldInfoPriceList,boolean isAll,String[] delId, Model model, RedirectAttributes redirectAttributes) {
		User user= UserUtils.getUser();

		if (!beanValidator(model, fieldInfo)){
			return form(fieldInfo, model);
		}
