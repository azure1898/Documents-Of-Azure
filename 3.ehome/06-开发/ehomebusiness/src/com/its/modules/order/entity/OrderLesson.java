 ...
 * @version 2017-07-19
 */
public class OrderLesson extends DataEntity<OrderLesson> {
    ...
    @ExcelField(title = "课程名称", type = 1, align = 2, sort = 4)
    ...
    @ExcelField(title = "订单状态", type = 1, align = 2, sort = 7, dictType = "order_lesson_state")
