...
<body>
	...
	<form:form id="searchForm" modelAttribute="orderLesson" action="${ctx}/order/orderLesson/" method="post" class="breadcrumb form-search"  style="width:95.5%">
		...
		<ul class="ul-form">
			...
			<li class="btns"><i class="icon-search icon-white"></i><input id="btnSubmit" class="btn btn-success" type="submit" onclick="changeAction('0')"
				value="查询" /></li>
		...
		<tbody>
			<c:forEach items="${page.list}" var="orderLesson" varStatus="status">
				<tr>
					...
					<td><a id="btuElemView" class="btn btn-primary" href="${ctx}/order/orderLesson/form?id=${orderLesson.id}"><i
							class="icon-align-justify icon-custom"></i>查看</a> <br /> <shiro:hasPermission name="order:orderLesson:edit">
