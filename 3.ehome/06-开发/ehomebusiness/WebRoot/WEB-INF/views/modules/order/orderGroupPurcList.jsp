...
<body>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed">
        ...
        <c:forEach items="${page.list}" var="orderGroupPurc" varStatus="status">
           	<tr>
                <td><a href="${ctx}/order/orderGroupPurc/form?id=${orderGroupPurc.id}">
                    ${orderGroupPurc.orderNo}
                </a></td>
                <td>
               	 <a href="${ctx}/coupon/groupPurchase/detail?id=${orderGroupPurc.groupPurchaseId}">
                    ${orderGroupPurc.name}
                  </a>
                </td>
                <td>
                ...
                <td <c:if test="${orderGroupPurc.orderState == 0}">style="color:red"</c:if>>
