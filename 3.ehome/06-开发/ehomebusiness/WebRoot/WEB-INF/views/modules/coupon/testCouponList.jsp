...
<head>
	...
	<style type="text/css">
		.breadcrumb {padding: 8px 15px;margin: 0 0 20px;list-style: none;background-color: #f5f5f5;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;border: 1px solid #e0e5eb;margin: 10px;}
    </style>
...
<body>
    ...
    <form:form id="searchForm" modelAttribute="orderGroupPurcList" action="${ctx}/coupon/testCoupon/" method="post" class="breadcrumb form-search" style="width:700px;">		
		<ul class="ul-form">
			...
			<li class="btns" style="float:right;margin-right:60px"><input id="btnSubmit" class="commonbtn" style="width:80px" type="submit" value="查找券号" onclick="querySub()"/></li>
	    ...
	    <div id="confirm"  class="breadcrumb" style="width:700px;">
	    	<div style="margin-bottom:5px">
	    		...
	    		<div style="float:right;margin-right:63px">
	    		   <input id="btnConfirm" class="commonbtn" style="width:80px" type="submit" value="确认消费" disabled="disabled"/>
	    		</div>
	    	</div>
	    ...
	    <div id="confirmResult" class="breadcrumb" style="width: 700px;display:none;">
	    	<div style="margin-bottom:5px">
		    	...
		    	<div style="float:right;margin-right:65px">
			    	<input id="btnReturn" class="commonbtn" style="width:60px" type="submit" value="返回"/>
			    </div>
			 </div>
	    </div>
	    <!-- 券号列表 -->
	    <div id="numberList"  class="breadcrumb" style="width: 700px;">
	    	<table id="contentTable" class="table table-striped table-bordered table-condensed" style="margin-left:1px;">
				<thead>
					<tr>
