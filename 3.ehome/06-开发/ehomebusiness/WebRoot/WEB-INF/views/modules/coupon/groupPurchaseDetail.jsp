...
<head>
	...
	<script type="text/javascript">
		...
		function addRow(i,section){
			...
			'"></label>&nbsp;<label style="margin-left:240px">结束时间：</label><label id="endTime'+i+'"></label>&nbsp;</div>'
   ...
   <ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="groupPurchase" method="post" class="form-horizontal">
				...
				<td>
					<div id="timeList">
						...
						<div class="control-group">	
							...
							<div class="controls">
								<label id="startTime0"></label>&nbsp;
								<label style="margin-left:240px">结束时间：</label>
								<label id="endTime0"></label>&nbsp;
							</div>
						</div>	
					</div>
				</td>
		...
		<div class="form-actions">
            <input id="btnCancel" class="commonbtn" style="margin-left:550px;width:80px" type="button" value="返 回" onclick="history.go(-1)" />
        </div>
	</form:form>
