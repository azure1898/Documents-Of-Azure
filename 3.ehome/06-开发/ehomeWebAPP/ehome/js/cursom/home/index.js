        ...
        mounted: function () {
            this.$nextTick(function () {
                ...
                this.getData(_this, '/live/getTopic', data, function (resData) {
                    ...
                    //              if (_this.topic) {
                    //              	_this.topic.forEach(function(e,i){
                    //              		switch (e.topicData.length) {
                    //                      case 2:
                    //                          _this.topicClass = 1;
                    //                          break;
                    //                      case 3:
        ...
        methods: {
            ...
            topicClick: function (topic) {
                if (topic.recommendType == 1) {
                    switch (topic.recommendMode) {
                        case "0":
                            location.href = _this.urlList.business + topic.recommendID;
                            break;
                        case "1":
                            location.href = _this.urlList.service + topic.recommendID;
                            break;
                        case "2":
                            location.href = _this.urlList.course + topic.recommendID;
                            break;
                        case "3":
                            location.href = _this.urlList.site + topic.recommendID;
                            break;
                    }
                }
                else {
