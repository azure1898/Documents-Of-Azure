    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            addCommodityNum: function (commodity) {
                ...
                if (_this.commodity.currentSpeID == commodity.specificationID) {
                    _this.commodity.commodityNumber = commodity.commodityNumber;
                }

                if (_this.commodity.isMoreSpe == 1) {
                    _this.commodity.specifications.forEach(function (specification, index) {
