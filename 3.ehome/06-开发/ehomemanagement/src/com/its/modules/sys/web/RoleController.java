...
public class RoleController extends BaseController {
    ...
    @RequiresPermissions(value = { "sys:role:add", "sys:role:edit", "sys:role:authorize" }, logical = Logical.OR)
    ...
    public String delete(Role role, RedirectAttributes redirectAttributes) {
        ...
        if (UserUtils.getUser().getRoleIdList().contains(role.getId())) {
            ...
            redirectAttributes.addFlashAttribute("msgType", "error");
            addMessage(redirectAttributes, "角色已关联用户，不能删除");
        }else{
     ...
     * @return
     */
    @RequiresPermissions("sys:role:authorize")
