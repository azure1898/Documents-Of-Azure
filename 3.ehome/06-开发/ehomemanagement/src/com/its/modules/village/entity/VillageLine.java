...
public class VillageLine extends DataEntity<VillageLine> {
    ...
    private String communityRecomModuleSort; // 社区推荐模块排序
    private String lifeRecomModuleSort; // 生活推荐模块排序
    ...
    public String[] getCommunityModuleSortIds() {
        if (communityModuleSort != null) {
            return communityModuleSort.split(",");
        } else {
            return null;
        }
    }
    ...
    public String[] getMaintRecomModuleSortIds() {
        if (maintRecomModuleSort != null) {
            return maintRecomModuleSort.split(",");
        } else {
            return null;
        }
    }
    ...
    public String[] getLifeRecomModuleSortIds() {
        if (lifeRecomModuleSort != null) {
            return lifeRecomModuleSort.split(",");
        } else {
            return null;
        }
    }
    ...
    public String[] getCommunityRecomModuleSortIds() {
        if (communityRecomModuleSort != null) {
            return communityRecomModuleSort.split(",");
        } else {
            return null;
        }
    }
