...
public class WXUtils {
	...
	public static void main(String[] args) {
		Map<String, String> map = WXUtils.doDownloadBill("20170814", "SUCCESS", null);
	}
	 ...
	 * @return
	 */
	static public Map<String, String> doDownloadBill(String billDate, String billType) {
		return doDownloadBill(billDate, billType, null);
	}
	 ...
	 * @return
	 */
	static public Map<String, String> doDownloadBill(String billDate, String billType, String tarType) {
		InputStream in = null;
		in = WXUtils.class.getClassLoader().getResourceAsStream("wx-config.properties");
		try {
			props.load(in);
	 ...
	 * @throws Exception
	 */
	private static Map<String, String> downloadBill(Map<String, String> reqData) throws Exception {
		return downloadBill(reqData, WXUtilsConfig.HTTP_CONNECT_TIMEOUTMS, WXUtilsConfig.HTTP_READ_TIMEOUTMS);
	}
	 ...
	 * @throws Exception
	 */
	private static Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs,
			int readTimeoutMs) throws Exception {
		Map<String, String> result = new HashMap<String, String>();
		String url = WXUtilsConfig.DOWNLOADBILL_URL_SUFFIX;
		String respXml = requestWithCert(url, fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);

		if (respXml.toLowerCase().startsWith("<xml>")) {
			result = processResponseXml(respXml);
		} else {
			result.put("return_code", "200");
			result.put("return_msg", respXml);
		}
