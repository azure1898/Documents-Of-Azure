...
public class WXUtils {
     ...
     *            商户号
     */
    static public Map<String, String> doRefund(String out_trade_no, String out_refund_no, String total_fee, String refund_fee) {
        ...
        data.put("op_user_id", WXUtilsConfig.MCH_ID);
    ...
    private static Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("appid", WXUtilsConfig.APP_ID);
        reqData.put("mch_id", WXUtilsConfig.MCH_ID);
        reqData.put("nonce_str", generateUUID());
        reqData.put("sign_type", WXUtilsConfig.MD5);
        reqData.put("sign", generateSignature(reqData, WXUtilsConfig.KEY));
        return reqData;
    }
     ...
     * @throws Exception
     */
    private static String requestWithCert(String urlSuffix, Map<String, String> reqData,
    ...
    public static boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return isSignatureValid(reqData, WXUtilsConfig.KEY, WXUtilsConfig.SignType.MD5);
    }
}
