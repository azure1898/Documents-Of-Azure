...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			if ($("#createDateEnd").val() < $("#createDateStart").val()) {
...
<body>
	...
	<form:form id="searchForm" modelAttribute="editionManage" action="${ctx}/edition/editionManage/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
		     <li>
				<input id="createDateStart" name="createDateStart" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="<fmt:formatDate value="${editionManage.createDateStart}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</li>
			<li>-
				<input id="createDateEnd" name="createDateEnd" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="<fmt:formatDate value="${editionManage.createDateEnd}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</li>
			<li>&nbsp;&nbsp;&nbsp;
