...
<body>
    <ul class="nav nav-tabs">
        <li>
             <span>系统管理 > <a href="${ctx}/sys/role/list">角色管理> </a>角色授权
            </span>
        </li>
    </ul>
    <br />
    <form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
        ...
        <div class="control-group" style="display: none;">
            ...
            <div class="controls">
                <sys:treeselect id="office" name="office.id" value="1" labelName="office.name" labelValue="${role.office.name}" title="机构" url="/sys/office/treeData" cssClass="required" />
            </div>
        </div>
        <div class="control-group" style="display: none;">
        ...
        <div class="control-group" style="display: none;">
            ...
            <div class="controls">
                ...
                <span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务"> 工作流组用户组类型（普及内部：assignment、实地物业：security-role、普通角色：user）</span>
            </div>
        </div>
        <div class="control-group" style="display: none;">
