...
<script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#inputForm").validate({
                rules: {
                    name: {checkSpecialCharacters : true,remote: "${ctx}/sys/role/checkName?oldName=" + encodeURIComponent("${role.name}")},
                    enname: {remote: "${ctx}/sys/role/checkEnname?oldEnname=" + encodeURIComponent("${role.enname}")}
                },
                messages: {
                    name: {remote: "角色名已存在",required: "请输入角色名"},
                    remarks: {required: "请输入角色描述"},
                    roleType: {required: "请选择角色所属"},
                },
...
<body>
    ...
    <form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label">角色所属:</label>
            <div class="controls">
