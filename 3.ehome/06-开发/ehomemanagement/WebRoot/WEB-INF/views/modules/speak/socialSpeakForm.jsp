...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/speak/socialSpeak/">我来发言</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="socialSpeak" enctype="multipart/form-data" action="${ctx}/speak/socialSpeak/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="" htmlEscape="false" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea style="height:100px; width:300px;" path="content" htmlEscape="false" maxlength="500" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="forbitcomment" items="${fns:getDictList('forbitComment')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="forbidforward" items="${fns:getDictList('forbidForward')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required" />
                <span class="help-inline">
                    <font color="red">*</font>
                </span>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="speak:socialSpeak:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
