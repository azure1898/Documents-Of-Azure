...
<head>
	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					...
					for(var  i=0;i<data.length;i++){					
						...
						$("#startTime"+i).text(startTimes);
						$("#endTime"+i).text(endTimes);
		...
		function addRow(i){
			...
			'" style="width:100px;">&nbsp;件</label>&nbsp;&nbsp;&nbsp;&nbsp;'+'<input style="border:1px solid #EEEE00;background-color:#FFFFBB;color:red;text-align:center;" type="text" class="input-medium" disabled="disabled" id="saleNum'+i+'"value="" ></input>'+'</div>'
...
<body>
	...
	<ul class="nav nav-tabs">
        <li style="height:30px"> 运营管理><span><a href="${ctx}/operation/groupPurchase/">团购管理 </a>
        > 团购详情
        </span>
        </li>
    </ul>
	...
	<form:form id="inputForm" modelAttribute="groupPurchase" method="post" class="form-horizontal">
					...
					<div id="timeList">
						<div class="control-group">
							<div class="control">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库存量：
								<label id="stockNum0" style="width:100px;">${groupPurchase.stockNums}&nbsp;件</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input id="saleNum0" style="border:1px solid #EEEE00;background-color:#FFFFBB;color:red;text-align:center;" type="text" class="input-medium" disabled="disabled"></input>
							</div>
						</div>	
					</div>
				</td>
		...
		<div class="form-actions">
            <input id="btnCancel" class="btn btn-success" style="margin-left:500px;" type="button" value="返 回" onclick="history.go(-1)" />
        </div>
	</form:form>
